...
export const SOLAR_TERM_DATES: Record<string, string> = {
  ...
  // 2027
  '2027-01-05': '小寒', '2027-01-20': '大寒', '2027-02-04': '立春', '2027-02-18': '雨水',
  '2027-03-05': '驚蟄', '2027-03-21': '春分', '2027-04-05': '清明', '2027-04-20': '穀雨',
  ...
  '2028-09-07': '白露', '2028-09-22': '秋分', '2028-10-07': '寒露', '2028-10-23': '霜降',
...
// Exact lunar month segments for 2026 (including adjacent buffer days) matching IMG_4563.jpeg
const EXACT_2026_SEGMENTS = [
  ...
  // 2026 八月: 9/11 is 八月初一, ends 10/9 (廿九), 29 days (9/13 初三 [Today!], 9/25 中秋 十五)
  ...
  // 2026 臘月 (buffer for Jan 2027)
  { m: 12, year: 2026, name: '臘月', startSolar: '2027-01-08', startDay: 1, count: 30, isLeap: false, ganzhi: '丙午年', zodiac: '馬' },
];

const EXACT_LUNAR_MAP: Record<string, LunarDayInfo> = (() => {
  const map: Record<string, LunarDayInfo> = {};
  for (const seg of EXACT_2026_SEGMENTS) {
...
// Lunar calendar converter using Exact Table (for 2026) or Intl.DateTimeFormat (for other years)
export function getLunarInfo(date: Date): LunarDayInfo {
  ...
  // Prioritize exact Taiwan official calendar mapping for 2026
